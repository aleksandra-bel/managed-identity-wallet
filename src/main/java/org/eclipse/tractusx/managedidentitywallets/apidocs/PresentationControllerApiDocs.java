...
public class PresentationControllerApiDocs {
    ...
    @RequestBody(content = {
            @Content(examples = {
                    @ExampleObject(name = "Request Presentation by presentationDefinition", value = """
                            {
                              "@context": [
                    ...
                    @ExampleObject(name = "Request Presentation by scope", value = """
                            {
                              "@context": [
                                "https://w3id.org/tractusx-trust/v0.8",
                                "https://identity.foundation/presentation-exchange/submission/v1"
    ...
    @Operation(summary = "Create Verifiable Presentation", description = "Create a verifiable presentation for the verifiable credential types listed in STS token", security = { @SecurityRequirement(name = "sts_token_bearer") })
    @ApiResponses(value = {
            @ApiResponse(responseCode = "401", description = "The request could not be completed due to a failed authorization.", content = {
                    @Content(examples = {}) }),
            @ApiResponse(responseCode = "403", description = "The request could not be completed due to a forbidden scope value", content = {
    ...
    public @interface GetVerifiablePresentationQueryApiDocs {
    }
}
